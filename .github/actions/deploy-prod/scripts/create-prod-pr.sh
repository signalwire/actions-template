...
if [[ "$DRY_RUN" == "true" ]]; then
  ...
  yq eval -i "
    (.services[].image | select(test(\"${SERVICE_NAME}\"))) = \"${DOCKER_REPO}:${NEW_IMAGE_TAG}\"
  " "$STACK_FILE"
...
---
*This PR was automatically generated by the [deploy-prod](https://github.com/signalwire/actions-template) workflow.*"
